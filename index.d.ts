...
declare class PostHog {
     ...
     */
    identify({ distinctId, properties }: IdentifyMessage, callback?: Function ): void
     ...
     */
    capture({ distinctId, event, properties, groups }: EventMessage, callback?: Function ): void
     ...
     */
    alias(message: { distinctId: string; alias: string }, callback?: Function): void
     ...
     * @param properties OPTIONAL | which can be a object with any information you'd like to add
    */
    groupIdentify({ groupType, groupKey, properties }: GroupIdentifyMessage, callback?: Function): void
